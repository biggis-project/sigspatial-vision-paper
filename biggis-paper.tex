...
\title{BigGIS: A Next Generation Predictive and Prescriptive Geographic
Information System (Vision Paper)}
...
%\additionalauthors{John Smith (FZI,
...
data storage and semantic web services capabilities with human-side perceptive
...
and dissolve heterogeneity in data and metadata such that the information gain
...
prescriptive way. While the descriptive analysis visualizes the status quo, predictive and 
...
again probability distributions. The resulting models are then probability
distributions as well, which can then be used in our continuous refinement
