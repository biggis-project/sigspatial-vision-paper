...
Section \ref{sec:related} discusses related work and influencing fields of r
esearch. The platforms' design is introduced in Section \ref{sec:biggis}
through the continuous refinement model, while major challenges are
presented. Use cases shown in Section \ref{sec:use}. Finally, Section
...
use~\cite{Keim2008}, \cite{keim2010mastering}, especially
...
uncertainty to continuously refine results as shown in Figure \ref{fig:biggisworkflow}. 
