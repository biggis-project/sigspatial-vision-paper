...
described data sources and data transformation services as discussed in~\cite{Frank.2016a}. Smart web services
...
\begin{inparaenum}[(1)]
	...
	\item emergency management, i.e. identification and dispersion of hazardous gas in chemical accidents.
\end{inparaenum}
