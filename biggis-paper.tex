...
Frank\textsuperscript{3}, Viliam Simko\textsuperscript{3}, Jens
...
streaming data to overcome eachs single weakenesses. Thakur et al. introduce
PlanetSense~\cite{Thakur2015}, a real-time streaming and
...
runtime. However, developments in the field of semantic web technologies
...
web technologies help to describe data sources using widely-applied 
...
\textit{Cognitive Apps}. The former abstracts away the user from manually 
...
either provided with additional domain expert knowledge by another person or he
...
official meteorological station, have inaccuracies. Models derived from data
...
requirements of different GISs based on the semantic metadata~\cite{Frank.2016b}. 
...
restrictions is one problem which we hope to present a solution for. Here, the
challenge lies in the speed of computation, the different level of expertise
for each user and the available bandwidth to transfer information back to the
user and the analytics pipeline.
...
rapidly increasing distribution and usage of mobile devices and Internet of
Things as well as the emergence of new data sources lead to more diverse,
larger and unreliable data. In this paper, we proposed BigGIS, a next
generation predictive and prescriptive GIS, that leverages big data analytics,
semantic web technologies and visual analytics methodologies through a novel
continuous refinement model. We showed what we consider are the key elements to
master heterogeneity and uncertainty in spatio-temporal big data to generate
meaningful knowledge and identified three main challenges.
Currently, we are working on an integrated prototype to support each of
